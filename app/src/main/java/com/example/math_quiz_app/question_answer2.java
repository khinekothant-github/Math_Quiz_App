...
public class question_answer2 extends AppCompatActivity implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        if (clickButton.equals(submit)) {
            if (!isAnswerShown) {
                ...
                loadNewQuestion();
                isAnswerShown = false;
                submit.setText(" Change the background color of the clicked button to greenSubmit");
            }
        } else {
    ...
    void finishQuiz(){
        ...
        Intent intent = new Intent(question_answer2.this,result.class);
